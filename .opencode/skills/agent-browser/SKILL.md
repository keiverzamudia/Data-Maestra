...
2. `agent-browser snapshot` - Capture accessibility tree with refs
3. `agent-browser act click @e1` - Interact via ref
4. `agent-browser screenshot` - Visual proof

## Observability Dashboard

Runs on port 4848. Do not expose session ports.
